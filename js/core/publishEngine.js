...
export async function doExportWebsite(){
  ...
  const shellCss=[
    ...
    '.ws-canvas .cf-column-layout{display:flex;align-items:stretch;width:100%;margin:16px 0;position:relative;min-height:60px;gap:0;border:none!important}',
    '.ws-canvas .cf-column-item{flex:1;min-height:60px;padding:16px 20px;font-size:1rem;line-height:1.8;color:var(--text);word-break:break-word;background:transparent!important;outline:none!important}',
    '.ws-canvas .cf-col-sep-line{width:6px;background:transparent;flex-shrink:0;cursor:default;position:relative;display:flex;align-items:center;justify-content:center}',
    '.ws-canvas .cf-col-sep-line::after{content:"";position:absolute;top:12px;bottom:12px;width:1px;background:var(--border);border-radius:1px;opacity:.4}',
