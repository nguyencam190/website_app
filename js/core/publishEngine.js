...
export async function doExportWebsite(){
  ...
  const shellCss=[
    ...
    '.ws-canvas .editor-content td.tbl-has-img,.ws-canvas .editor-content th.tbl-has-img{vertical-align:top;box-sizing:border-box}',
    '.ws-canvas .editor-content td.tbl-has-img img,.ws-canvas .editor-content th.tbl-has-img img{max-width:100%;height:auto;display:block;margin:0 auto}',
